...
import { View, Text, TextInput, TouchableOpacity, ScrollView, Modal, Animated, Easing, ActivityIndicator, Image } from "react-native";
...
export default function ServicesPage() {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: lightBeige }}>
            {/* Fixed header - no SafeAreaView wrapper needed */}
